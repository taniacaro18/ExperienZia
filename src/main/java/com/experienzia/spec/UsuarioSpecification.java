...
// Filtros dinámicos para que el admin busque usuarios en la BD sin escribir SQL a mano
public class UsuarioSpecification {
    ...
    // Rol exacto: ASISTENTE, ORGANIZADOR, STAFF, ADMIN
    ...
    // Staff ligado a un organizador (campo organizadorId en la tabla usuario)
